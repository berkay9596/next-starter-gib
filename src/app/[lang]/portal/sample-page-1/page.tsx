...
const SamplePage1 = ({ params }: { params: { lang: Locale } }) => {
    ...
    const schema = {
        firstName: yup.string().required(page.sayfa1.formValidationMessage),
        lastName: yup.string().required(page.sayfa1.formValidationMessage),
        age: yup.string().required(page.sayfa1.formValidationMessage)
    };
    ...
    const afterSubmit = (res: any) => {
        ...
        enqueueSnackbar(page.sayfa1.snackbarMessage, {
            variant: "success"
        });
    };
        ...
        <Stack spacing={3} ml={width < 1200 ? "22px" : "0"}>
            ...
            <Paper style={{ padding: "1rem", display: "grid" }}>
                <Form
                    ...
                    confirmButtonLabel={page.sayfa1.submitButton}
                    resetButtonLabel={page.sayfa1.resetButton}
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={4}>
                            <InputField
                                id="firstName"
                                name="firstName"
                                labeltext={page.sayfa1.firstName}
                                inputProps={{
                                    maxLength: 50,
                                    inputMode: "text"
                                }}
                        ...
                        <Grid item xs={4}>
                            <InputField
                                id="lastName"
                                name="lastName"
                                labeltext={page.sayfa1.lastName}
                                inputProps={{
                                    maxLength: 50,
                                    inputMode: "text"
                                }}
